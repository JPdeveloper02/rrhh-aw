...
class PlanillaController extends Controller
{
    ...
    public function BuscarPlanilla(Request $request)
    {
        ...
        $tareos = Tareo::join('contrato', 'tareo.idContrato', '=', 'contrato.idContrato')
            ...
            ->join('fondodepension', 'empleado.idFondoDePension', '=', 'fondodepension.idFondoDePension')
            ->whereBetween('tareo.Fecha', [$dia_inicio, $dia_fin])
            ->whereIn('datoscontables.idDatosContables', function ($query) {
                $query->select(DB::raw('MAX(idDatosContables)'))
                    ->from('datoscontables')
                    ->groupBy('idContrato');
            })
            ->groupBy('contrato.idContrato', 'persona.Nombres', 'persona.DNI', 'persona.ApellidoPaterno', 'estaciondetrabajo.NombreEstacionDeTrabajo', 'fondodepension.NombreEntidad', 'persona.Email', 'datoscontables.idDatosContables')
            ->select('contrato.idContrato', 'persona.Nombres', 'persona.DNI', 'persona.ApellidoPaterno', 'estaciondetrabajo.NombreEstacionDeTrabajo', 'persona.Email', 'fondodepension.NombreEntidad', 'datoscontables.idDatosContables', 'datoscontables.SueldoBase as SueldoBase')
            ->get();
