...
return [
    ...
    */
    ...
    //'classes_sidebar' => 'bg-primary elevation-4',
    'classes_sidebar_nav' => '',
    ...
    */
    ...
    'menu' => [
        ...
        ['header' => 'SEGUIMIENTO DE PERSONAL'],
        [
            'text' => 'Personal',
            'url'  => 'personal',
            'icon' => 'fas fa-user',
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Registro de tareos',
                    'url'  => 'tareos',
                ],
                [
                    'text'    => 'Días tareados',
                    'url'     => 'tareos/diastareados',
                ],
                [
                    'text'    => 'Fotos tareo',
                    'url'     => 'tareos/fotos',
        ...
        [
            'text' => 'Cumplimientos legales',
            'icon' => 'fas fa-gavel',
            'submenu' => [
                [
                    'text' => 'Documentos',
                    'url'  => 'cumplimientos-legales',
                ],
            ],
        ],
        [
